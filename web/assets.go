...
// HTTP server — plain HTML/CSS/JS, no build step, no framework. PDF.js
// (internal/../web/static/vendor/pdfjs) is vendored here too, so page
// thumbnails render entirely in the browser with no server round trip.
package web
